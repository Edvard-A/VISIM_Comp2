	...
	: mWindow(w)
{
    ...
    mObjects.push_back(new TriangleSurface("C:\\Users\\edvar\\Downloads\\data_Export.txt")); // dataset
    // Dag 030225
    ...
    mObjects.at(3)->move(-477617, -7461897, 0); // adjust dataset position to fit world
...
void Renderer::initResources()
{
    ...
    rasterization.polygonMode = VK_POLYGON_MODE_POINT;          // Render as points/pointcloud
    ...
    mTextureHandle = createTexture((assetPath + "green.png")); //Heightmap.jpg HundA.bmp
